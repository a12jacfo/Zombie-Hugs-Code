...
HumanCatcher::HumanCatcher(Tile& tile, std::string name) :
	m_walkLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_walk_straight_left.png" ), 200, 4),
	m_walkRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_walk_straight_right.png" ), 200, 4),
	m_walkUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_walk_up_left.png" ), 200, 4),
	m_walkUpRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_walk_up_right.png" ), 200, 4),
	m_walkDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_walk_down_left.png" ), 200, 4),
	m_walkDownRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_walk_down_right.png" ), 200, 4),

	m_idelLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_idle_left.png" ), 200, 2),
	m_idelRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_idle_right.png" ), 200, 2),
	m_idelSitLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_sit_idle_left.png" ), 200, 2),
	m_idelSitRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_sit_idle_right.png" ), 200, 2),
	m_idelStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_stunned_left.png" ), 200, 1),
	m_idelStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_stunned_right.png" ), 200, 1),
	
	m_skillCatchDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_skills_spray_left.png" ), 200, 10),
	m_skillCatchDownRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_skills_spray_right.png" ), 200, 10),
	m_skillCatchUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_skills_spray_up_left.png" ), 200, 10),
	m_skillCatchUpRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_skills_spray_up_right.png" ), 200, 10),

	//Zombie
	m_c_walkLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_walk_straight_left.png" ), 200, 4),
	m_c_walkRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_walk_straight_right.png" ), 200, 4),
	m_c_walkUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_walk_up_left.png" ), 200, 4),
	m_c_walkUpRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_walk_up_right.png" ), 200, 4),
	m_c_walkDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_walk_down_left.png" ), 200, 4),
	m_c_walkDownRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_walk_down_right.png" ), 200, 4),

	m_c_idelLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_idle_left.png" ), 200, 2),
	m_c_idelRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_idle_right.png" ), 200, 2),
	m_c_idelSitLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_sit_idle_left.png" ), 200, 2),
	m_c_idelSitRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_sit_idle_right.png" ), 200, 2),
	m_c_idelStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_stunned_left.png" ), 200, 1),
	m_c_idelStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_stunned_right.png" ), 200, 1),
	...
	m_GetStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_stunned_left.png" ), 200, 1),
	m_GetStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_stunned_right.png" ), 200, 1),
	m_c_GetStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_stunned_left.png" ), 200, 1),
	m_c_GetStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/leo/leo_c/leo_c_stunned_right.png" ), 200, 1)
{
...
void HumanCatcher::update(sf::RenderWindow &window, bool &m_Unit_is_Walking)
{
	...
	{
		m_Sound.setBuffer(AudioManager::getInstance()->get_sound("Resources/Audio/Sounds/Humans/Leo/select.wav"));
	...
	{
		m_Sound.setBuffer(AudioManager::getInstance()->get_sound("Resources/Audio/Sounds/Humans/Leo/order.wav"));
		m_Sound.setLoop(false);
		m_Sound.play();	
