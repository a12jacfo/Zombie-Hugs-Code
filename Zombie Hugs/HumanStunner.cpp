...
HumanStunner::HumanStunner(Tile& tile, std::string name) :
	m_walkLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_walk_straight_left.png" ), 200, 4),
	m_walkRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_walk_straight_right.png" ), 200, 4),
	m_walkUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_walk_up_left.png" ), 200, 4),
	m_walkUpRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_walk_up_right.png" ), 200, 4),
	m_walkDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_walk_down_left.png" ), 200, 4),
	m_walkDownRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_walk_down_right.png" ), 200, 4),

	m_idelLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_idle_left.png" ), 200, 2),
	m_idelRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_idle_right.png" ), 200, 2),
	m_idelSitLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_sit_idle_left.png" ), 200, 2),
	m_idelSitRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_sit_idle_right.png" ), 200, 2),
	m_idelStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_stunned_left.png" ), 200, 1),
	m_idelStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_stunned_right.png" ), 200, 1),

	m_skillStunnUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_skills_stunn_left.png" ), 200, 10),
	m_skillStunnUpRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_skills_stunn_right.png" ), 200, 10),
	m_skillStunnDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_skills_stunn_left.png" ), 200, 10),
	m_skillStunnDownRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_skills_stunn_right.png" ), 200, 10),

	//Zombie
	m_c_walkLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_walk_straight_left.png" ), 200, 4),
	m_c_walkRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_walk_straight_right.png" ), 200, 4),
	m_c_walkUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_walk_up_left.png" ), 200, 4),
	m_c_walkUpRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_walk_up_right.png" ), 200, 4),
	m_c_walkDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_walk_down_left.png" ), 200, 4),
	m_c_walkDownRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_walk_down_right.png" ), 200, 4),

	m_c_idelLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_idle_left.png" ), 200, 2),
	m_c_idelRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_idle_right.png" ), 200, 2),
	m_c_idelSitLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_sit_idle_left.png" ), 200, 2),
	m_c_idelSitRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_sit_idle_right.png" ), 200, 2),
	m_c_idelStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_stunned_left.png" ), 200, 1),
	m_c_idelStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_stunned_right.png" ), 200, 1),
	...
	m_GetStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_get_stunned_left.png" ), 200, 5),
	m_GetStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_get_stunned_right.png" ), 200, 5),
	m_c_GetStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_stunned_left.png" ), 200, 5),
	m_c_GetStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/liz/liz_c/liz_c_stunned_right.png" ), 200, 5)
{
...
void HumanStunner::update(sf::RenderWindow &window, bool &m_Unit_is_Walking)
{
	...
	{
		m_Sound.setBuffer(AudioManager::getInstance()->get_sound("Resources/Audio/Sounds/Humans/Liz/select.wav"));
	...
	{
		m_Sound.setBuffer(AudioManager::getInstance()->get_sound("Resources/Audio/Sounds/Humans/Liz/order.wav"));
		m_Sound.setLoop(false);
		m_Sound.play();	
