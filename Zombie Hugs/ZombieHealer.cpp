...
ZombieHealer::ZombieHealer(Tile& tile, std::string name) :
	m_walkLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_walk_straight_left.png" ), 200, 4),
	m_walkRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_walk_straight_right.png" ), 200, 4),
	m_walkUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_walk_up_left.png" ), 200, 4),
	m_walkUpRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_walk_up_right.png" ), 200, 4),
	m_walkDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_walk_down_left.png" ), 200, 4),
	m_walkDownRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_walk_down_right.png" ), 200, 4),

	m_idelLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_idle_left.png" ), 200, 2),
	m_idelRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_idle_right.png" ), 200, 2),
	m_idelSitLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_sit_idle_left.png" ), 200, 2),
	m_idelSitRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_sit_idle_right.png" ), 200, 2),
	m_idelStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_stunned_left.png" ), 200, 1),
	m_idelStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_stunned_right.png" ), 200, 1),

	m_skillHealLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_heal_left.png" ), 200, 10),
	m_skillHealRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_heal_right.png" ), 200, 10),

	//Zombie
	m_c_walkLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_walk_straight_left.png" ), 200, 4),
	m_c_walkRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_walk_straight_right.png" ), 200, 4),
	m_c_walkUpLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_walk_up_left.png" ), 200, 4),
	m_c_walkUpRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_walk_up_right.png" ), 200, 4),
	m_c_walkDownLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_walk_down_left.png" ), 200, 4),
	m_c_walkDownRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_walk_down_right.png" ), 200, 4),

	m_c_idelLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_idle_left.png" ), 200, 2),
	m_c_idelRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_idle_right.png" ), 200, 2),
	m_c_idelSitLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_sit_idle_left.png" ), 200, 2),
	m_c_idelSitRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_sit_idle_right.png" ), 200, 2),
	m_c_idelStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_stunned_left.png" ), 200, 1),
	m_c_idelStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_stunned_right.png" ), 200, 1),
	...
	m_GetStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_stunn_left.png" ), 200, 5),
	m_GetStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/Tom_stunn_right.png" ), 200, 5),
	m_c_GetStunnedLeft(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_get_stunned_left.png" ), 200, 5),
	m_c_GetStunnedRight(ImageManager::getInstance()->get_image( "Resources/Images/tom/tom_c/tom_c_get_stunned_right.png" ), 200, 5)
{
...
void ZombieHealer::update(sf::RenderWindow &window, bool &m_Unit_is_Walking)
{
	...
	{
		m_Sound.setBuffer(AudioManager::getInstance()->get_sound("Resources/Audio/Sounds/Zombies/Tom/select.wav"));
	...
	{
		m_Sound.setBuffer(AudioManager::getInstance()->get_sound("Resources/Audio/Sounds/Zombies/Tom/order.wav"));
		m_Sound.setLoop(false);
		m_Sound.play();	
